...
const double           EXPAND_COEF     = 2;         //!< new size of the stack = old size * EXPAND_COEF
const Elem_t           POISON_VALUE    = 1337;      //!< values for empty data elements
...
Elem_t StackPop     (Stack_t* stack, bool* error);
