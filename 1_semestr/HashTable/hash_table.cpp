...
extern int HashTablePush (HashTable* htable, char* value, Hash_t (*Hash)(void* buffer, size_t buffer_size)) noexcept;
...
//
//------------------------------------------------------------------------------------------
int HHashTablePush(HashTable* htable, char* value, Hash_t (*Hash)(void* buffer, size_t buffer_size)) noexcept {
